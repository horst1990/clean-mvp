package com.hor.mvp.data.http.logger;
...
public final class HttpLoggingInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        boolean logHeaders = level != Level.BODY_NOT_HEAD && (logBody || level == Level.HEADERS);
        ...
        if (logHeaders && response!=null && response.headers()!=null) {
